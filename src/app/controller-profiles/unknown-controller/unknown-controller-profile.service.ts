...
@Injectable()
export class UnknownControllerProfileService implements IControllerProfile {
    ...
    constructor(
        ...
        this.nameL10nKey = createControllerL10nKey('unknownControllerName');
    }
    ...
    public getAxisName$(
        ...
        return this.translocoService.selectTranslate(createControllerL10nKey('unknownControllerAxis'), { inputId });
    }
    ...
    public getButtonName$(
        ...
        return this.translocoService.selectTranslate(createControllerL10nKey('unknownControllerButton'), { inputId });
    }
}
