...
@Component({
    standalone: true,
    selector: 'app-operation-mode-select',
    templateUrl: './operation-mode-select.component.html',
    styleUrls: [ './operation-mode-select.component.scss' ],
    imports: [
        NgIf,
...
export class OperationModeSelectComponent implements OnChanges {
