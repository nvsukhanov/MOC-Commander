...
export const CHANGELOG: ChangelogRecords = [
  ...
  {
    version: '1.3.0',
    changeL10nKeys: ['changelog.1-3-0.accelerationBindingTypeAdded', 'changelog.1-3-0.addedPulseInputPreset'],
  },
  {
    version: '1.2.8',
    changeL10nKeys: [
  ...
  {
    version: '1.0.1',
    changeL10nKeys: ['changelog.1-0-1.featIncreaseGamepadReadFrequency', 'changelog.bugfixesAndImprovements'],
  },
  {
    version: '1.0.0',
    changeL10nKeys: ['changelog.1-0-0.initialRelease'],
  },
];
