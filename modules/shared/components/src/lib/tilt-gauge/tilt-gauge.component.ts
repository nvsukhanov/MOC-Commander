...
@Component({
  ...
  imports: [TiltGaugeSectorsComponent, NgTemplateOutlet, TiltGaugeValueComponent],
...
export class TiltGaugeComponent implements OnInit {
  ...
  @Input()
  public set tiltDegrees(v: number | null) {
    this._tiltDegrees = v;
  ...
  @Input()
  public set options(value: Partial<TiltGaugeOptions>) {
    this._options = {
      ...this.baseOptions,
      ...value,
    };
  ...
  public onValueClicked(event: Event): void {
