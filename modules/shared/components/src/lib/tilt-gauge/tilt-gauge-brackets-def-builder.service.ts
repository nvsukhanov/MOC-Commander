...
export class TiltGaugeBracketsDefBuilderService {
  constructor(private readonly sectorDefService: TiltGaugeSectorDefBuilderService) {}

  public createBracketsSectorDefs(options: TiltGaugeOptions): TiltGaugeSectorDefinition[] {
