...
export class ControlSchemeDecompressorService {
  ...
  public decompress(importString: string): DeepPartial<ControlSchemeModel> {
    ...
    const payloadByteArray = decodedPayload
      .split('')
  ...
  private isPayloadObject(result: unknown): result is ControlSchemeCompressionResult {
    return (
