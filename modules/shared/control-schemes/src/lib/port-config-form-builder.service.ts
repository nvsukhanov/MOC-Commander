...
export class PortConfigFormBuilderService {
  ...
  public build(): PortConfigEditForm {
    return this.formBuilder.group({
      ...
      accelerationTimeMs: this.formBuilder.control<number>(DEFAULT_ACC_DEC_PROFILE_TIME_MS, {
        nonNullable: true,
        validators: [
          Validators.required,
      ...
      decelerationTimeMs: this.formBuilder.control<number>(DEFAULT_ACC_DEC_PROFILE_TIME_MS, {
        nonNullable: true,
        validators: [
          Validators.required,
          Validators.min(PortConfigFormBuilderService.minAccDecProfileTimeMs),
