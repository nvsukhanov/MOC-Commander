...
export class RoutesBuilderService {
  ...
  public bindingCreate(schemeName: string): string[] {
    return [this.baseHref, ROUTE_SECTIONS.controlSchemes, encodeURI(schemeName), ROUTE_SECTIONS.bindingCreate];
  }
  ...
  public controllerView(controllerId: string): string[] {
    return [this.baseHref, ROUTE_SECTIONS.controllers, encodeURI(controllerId)];
  }

  public controlSchemeRename(schemeName: string): string[] {
    return [this.baseHref, ROUTE_SECTIONS.controlSchemes, encodeURI(schemeName), ROUTE_SECTIONS.controlSchemeRename];
  }
}
