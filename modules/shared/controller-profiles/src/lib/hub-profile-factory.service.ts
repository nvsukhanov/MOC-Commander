...
export class HubProfileFactoryService {
  constructor(private readonly hubProfileFactory: ControllerProfileHubFactoryService) {}

  public getHubProfile(hubId: string, hubName$?: Observable<string>): IControllerProfile<HubControllerSettings> {
