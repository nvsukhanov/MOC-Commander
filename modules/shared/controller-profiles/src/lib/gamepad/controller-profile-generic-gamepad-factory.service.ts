...
export class ControllerProfileGenericGamepadFactoryService {
  ...
  public fromGamepadAPI(gamepad: Gamepad): ControllerProfileGenericGamepad {
  ...
  public fromUid(uid: string, transloco: TranslocoService): ControllerProfileGenericGamepad | null {
