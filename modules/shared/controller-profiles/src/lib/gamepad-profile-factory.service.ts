...
export class GamepadProfileFactoryService {
  ...
  @Memoize()
  public getGamepadProfile(gamepad: Gamepad): IControllerProfile<GamepadSettings> {
  ...
  public getByProfileUid(profileUid: string): IControllerProfile<GamepadSettings | null> {
