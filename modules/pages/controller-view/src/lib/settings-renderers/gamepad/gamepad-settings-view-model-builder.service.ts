...
export class GamepadSettingsViewModelBuilderService {
  ...
  public buildViewModel(form: GamepadSettingsForm, settings: GamepadSettingsModel): GamepadSettingsViewModel {
  ...
  private buildAxisViewModel(
    ...
    for (const axisId of Object.keys(settings.axisConfigs)) {
      ...
      result.push({
        ...
        name$: profile$.pipe(switchMap((profile) => profile.getAxisName$(axisId))),
        rawValue$,
        outputValue$,
        isActivated$,
        areSettingsDefault$,
  ...
  private buildButtonViewModel(
    ...
    for (const buttonId of Object.keys(settings.buttonConfigs)) {
      ...
      result.push({
        ...
        name$: profile$.pipe(switchMap((profile) => profile.getButtonName$(buttonId))),
        rawValue$,
        outputValue$,
        isActivated$,
        areSettingsDefault$,
