...
@Component({
  ...
  imports: [ControlIgnoreInputComponent],
...
export class HubControllerSettingsComponent implements IControllerSettingsRenderer<HubControllerSettingsModel> {
  ...
  constructor(private readonly formBuilder: FormBuilder) {
    this.ignoreInputControl = this.formBuilder.control(false, { nonNullable: true });
  ...
  public loadSettings(settings: HubControllerSettingsModel): void {
