...
@Component({
  ...
  imports: [ReactiveFormsModule, MatSlideToggleModule, TranslocoPipe, ControlIgnoreInputComponent],
...
export class KeyboardsSettingsComponent implements IControllerSettingsRenderer<KeyboardSettingsModel> {
  ...
  constructor(
    ...
    this.formGroup = this.formBuilder.group({
      ...
      controllerType: this.formBuilder.control(ControllerType.Keyboard, {
        nonNullable: true,
      }) as FormControl<ControllerType.Keyboard>,
    ...
    this.settingsChanges$ = this.formGroup.valueChanges.pipe(map(() => this.formGroup.getRawValue()));
  }

  public loadSettings(settings: KeyboardSettingsModel): void {
