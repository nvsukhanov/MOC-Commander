...
@Component({
  ...
  imports: [RunBlockersListComponent, TranslocoPipe],
...
export class IssuesSectionComponent {
  ...
  private readonly hiddenSchemeRunBlockers: ReadonlySet<SchemeRunBlocker> = new Set([SchemeRunBlocker.AlreadyRunning]);
