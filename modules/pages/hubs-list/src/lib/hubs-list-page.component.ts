...
@Component({
  ...
  imports: [TranslocoPipe, HubInlineViewComponent, MatCardModule, ConfirmationDialogModule, HintComponent, AsyncPipe],
...
export class HubsListPageComponent implements OnInit {
  ...
  public forgetHub(hubId: string): void {
    this.confirmationService
      .confirm(this.translocoService.selectTranslate('hub.forgerHubNotificationConfirmationTitle'), {
