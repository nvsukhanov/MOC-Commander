...
export class WidgetsReadTaskFactoryService implements IWidgetsReadTasksFactory {
  private readonly widgetReaderTaskFactories: {
    [k in WidgetType]: IWidgetReadTaskFactory<WidgetConfigModel & { widgetType: k }>;
  } = {
  ...
  public createReadTasks(configs: ReadonlyArray<WidgetConfigModel>): Array<
    Observable<{
      widgetId: number;
