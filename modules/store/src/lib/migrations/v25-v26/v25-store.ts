...
export type V25SpeedBinding = Override<
  V26SpeedBinding,
  {
    inputs: {
...
>;
export type V25ServoBinding = Override<
  V26ServoBinding,
  {
    inputs: {
...
>;
export type V25StepperBinding = Override<
  V26StepperBinding,
  {
    inputs: {
...
>;
export type V25TrainBinding = Override<
  V26TrainBinding,
  {
    inputs: {
...
>;
export type V25GearboxBinding = Override<
  V26GearboxBinding,
  {
    inputs: {
      [OldInputAction.NextLevel]: V25ControlSchemeInput;
...
>;
export type V25SetAngleBinding = Override<
  V26SetAngleBinding,
  {
    inputs: {
