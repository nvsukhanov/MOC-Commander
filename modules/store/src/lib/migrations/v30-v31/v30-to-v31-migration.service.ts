...
export class V30ToV31MigrationService implements IMigration<V30Store, V31Store> {
  ...
  public migrate(prev: DeepPartial<V30Store>): DeepPartial<V31Store> {
  ...
  private migrateGearbox(b: V30GearboxBinding): V31GearboxBinding {
  ...
  private migrateTrain(b: V30TrainBinding): V31TrainBinding {
  ...
  private migrateSetAngle(b: V30SetAngleBinding): V31SetAngleBinding {
    return {
      ...b,
      inputs: {
  ...
  private migrateServo(b: V30ServoBinding): V31ServoBinding {
  ...
  private migrateSpeed(b: V30SpeedBinding): V31SpeedBinding {
  ...
  private migrateStepper(b: V30StepperBinding): V31StepperBinding {
  ...
  private migrateInput(input: V30InputConfig): V31InputConfig {
  ...
  private trimGain(input: V30InputConfig): V31InputConfig {
  ...
  private migrateWidgets(widgets: V30WidgetConfigModel[]): V31WidgetConfigModel[] {
  ...
  private isOldTiltWidget(w: V30WidgetConfigModel): w is OldTiltWidgetConfigModel {
