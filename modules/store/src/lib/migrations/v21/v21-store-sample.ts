...
export const V21_STORE_SAMPLE: DeepPartial<V21Store> = {
  hubs: {
    ids: ['00:0f:b0:fa:ce:2d', '00:0f:b0:fa:ce:3d', '00:0f:b0:fa:ce:4d'],
    entities: {
      '00:0f:b0:fa:ce:2d': {
  ...
  controllerSettings: {
    ids: ['hub-00:0f:b0:fa:ce:3d', 'gamepad-xbox360/0', 'keyboard', 'hub-00:0f:b0:fa:ce:4d', 'hub-00:0f:b0:fa:ce:2d'],
    entities: {
  ...
  attachedIoModes: {
    ...
    entities: {
      '0.0.16.0/0.0.16.0/46': {
        ...
        portInputModes: [1, 2, 3, 4],
        portOutputModes: [0, 1, 2, 3, 4],
        synchronizable: true,
      },
      '0.0.0.0/0.0.0.0/23': {
