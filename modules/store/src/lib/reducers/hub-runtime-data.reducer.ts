...
export const HUB_RUNTIME_DATA_FEATURE = createFeature({
  ...
  reducer: createReducer(
    ...
    on(
      ...
      (state, { hubId }): HubRuntimeDataState =>
    ...
    on(
      ...
      (state, data): HubRuntimeDataState =>
        HUB_RUNTIME_DATA_ENTITY_ADAPTER.updateOne(
          {
            id: data.hubId,
            changes: {
    ...
    on(
      HUB_RUNTIME_DATA_ACTIONS.batteryLevelReceived,
      (state, data): HubRuntimeDataState =>
        HUB_RUNTIME_DATA_ENTITY_ADAPTER.updateOne(
          {
            id: data.hubId,
    ...
    on(
      HUB_RUNTIME_DATA_ACTIONS.rssiLevelReceived,
      (state, { hubId, rssi }): HubRuntimeDataState =>
        HUB_RUNTIME_DATA_ENTITY_ADAPTER.updateOne(
          {
            id: hubId,
            changes: {
    ...
    on(
      HUB_RUNTIME_DATA_ACTIONS.buttonStateReceived,
      (state, { hubId, isButtonPressed }): HubRuntimeDataState =>
        HUB_RUNTIME_DATA_ENTITY_ADAPTER.updateOne(
          {
            id: hubId,
            changes: {
    ...
    on(
      ...
      (state, { hubId, hardwareVersion }): HubRuntimeDataState =>
        HUB_RUNTIME_DATA_ENTITY_ADAPTER.updateOne(
          {
            id: hubId,
            changes: {
    ...
    on(
      ...
      (state, { hubId, firmwareVersion }): HubRuntimeDataState =>
        HUB_RUNTIME_DATA_ENTITY_ADAPTER.updateOne(
          {
            id: hubId,
            changes: {
