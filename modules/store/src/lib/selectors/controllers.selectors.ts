...
export const CONTROLLER_SELECTORS = {
  ...
  selectKeyboard: createSelector(CONTROLLERS_SELECT_ALL, (controllers) =>
    controllers.find((c) => c.controllerType === ControllerType.Keyboard),
  ),
  isKeyboardDiscovered: createSelector(CONTROLLERS_SELECT_ALL, (controllers) =>
    controllers.some((c) => c.controllerType === ControllerType.Keyboard),
  ),
