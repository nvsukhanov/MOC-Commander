...
export const HUB_RUNTIME_DATA_SELECTORS = {
  ...
  selectIsHubConnected: (hubId: string) =>
    createSelector(HUB_RUNTIME_DATA_SELECTORS.selectByHubId(hubId), (hubRuntimeData): boolean => !!hubRuntimeData),
  ...
  selectHubRssi: (hubId: string) =>
    createSelector(HUB_RUNTIME_DATA_SELECTORS.selectByHubId(hubId), (hubRuntimeData) => hubRuntimeData?.rssi ?? null),
